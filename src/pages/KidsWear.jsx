...
const KidsWear = () => {
  const { kidsProducts } = useContext(AdminContext);
    ...
    <main className="min-h-screen">
      ...
      <section className="relative bg-[#071952] text-white py-20 md:py-32 overflow-hidden">
        ...
        <div 
          ...
          style={{ backgroundImage: "url('https://images.unsplash.com/photo-1519689680058-324335c77eba?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80')" }}
        ></div>
      ...
      <section className="bg-white border-b border-gray-200 py-6 sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-wrap gap-3 justify-center">
            ...
            <button onClick={() => setFilter("Boys")} className={getBtnClass("Boys")}>Boys</button>
            <button onClick={() => setFilter("Girls")} className={getBtnClass("Girls")}>Girls</button>
      ...
      <section className="bg-gradient-to-r from-[#D4A017] to-[#C39428] text-[#071952] py-12 md:py-16">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4 uppercase">Looking for Something Special?</h2>
          <p className="text-lg mb-6">Contact us for custom kids wear and special orders</p>
          <a
